...
#define STRING_CONFIG_H_AUTHOR "(jcbwhtly, ender-3-pro-bltouch-abl-sfs)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 14.39
  #define DEFAULT_bedKd 260.50
